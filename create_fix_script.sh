...
# Create the fix_python_version.sh script on the VPS
cat > fix_python_version.sh << 'EOF'
#!/bin/bash
...
chmod +x fix_python_version.sh
echo "✅ fix_python_version.sh script created successfully!"
echo "Now run: ./fix_python_version.sh"
